...
namespace o2scl {
  ...
  */
  class ldrop_crust : public o2scl::nucmass_ldrop_shell {
  ...
  protected:
	...
	Used in ldrop_crust::nucleus_be_solve().
    */
    ...
    public:
       ...
       */
      ldrop_solve_chi(ldrop_crust *tp, int Z, int N, double np, double nn, 
		      double T, double ne);
    ...
    */
    ...
    public:
      ...
      ldrop_be_deriv(ldrop_crust &ld, double Z, double N, double npout, 
